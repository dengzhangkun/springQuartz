...
public class CronUtil_bak {
    ...
    private static final String TRANS_CRON_FORMAT_DAY = "ss mm HH dd/ * ? yyyy";

    private static final String TRANS_CRON_FORMAT_WEEK = "ss mm HH ? * -- *";

    private static final String TRANS_CRON_FORMAT_MONTH = "ss mm HH dd MM/1 ? yyyy";

    public static void main(String[] args) throws Exception {
//        String result = getCron("day", "2019-08-11 12:11:00");
//       String result = getCron("MON", "2018-08-11 12:11:00");
//       String result = getCron("4", "2019-05-23 09:48:20");
//       String result = getCron("month", "2019-05-23 09:57:00");
//        String result = getCron("4", "2019-05-23 10:25:00");




//         String result = getCronByOnce("2019-05-23 09:49:50");//OK
//        String result = getCronToDate("50 49 09 23 05 ? 2019");//OK
